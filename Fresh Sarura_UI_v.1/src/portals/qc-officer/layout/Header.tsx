...
import { Leaf, Search, Bell, ClipboardList, Truck, CheckCircle, AlertTriangle, ArrowRight, RefreshCw } from 'lucide-react';
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3 pl-2 border-l border-gray-200 dark:border-gray-700">
                        <div className="text-right hidden md:block">
                            <p className="text-sm font-semibold text-[#222222] dark:text-white">Quality Control</p>
                            <p className="text-xs text-[#6B7280] dark:text-gray-400">qc@freshsarura.rw</p>
                        </div>
