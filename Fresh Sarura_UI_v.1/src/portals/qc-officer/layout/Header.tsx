...
import { Search, Bell, ClipboardList, Truck, CheckCircle, AlertTriangle, ArrowRight, RefreshCw, LogOut, ChevronDown } from 'lucide-react';
...
// --- Mock QC Search Index ---
const searchIndex = [
    { id: 1, type: 'Intake', title: 'INT-001', subtitle: 'French Beans – 08:30 AM', url: '/qc/intake', icon: Truck },
    { id: 2, type: 'Intake', title: 'INT-002', subtitle: 'Avocados (Hass) – 09:15 AM', url: '/qc/intake', icon: Truck },
    { id: 3, type: 'Inspection', title: 'Batch B-2026-045', subtitle: 'Pending QC Review', url: '/qc/inspection', icon: ClipboardList },
    { id: 4, type: 'Inspection', title: 'Batch B-2026-046', subtitle: 'Awaiting Sort', url: '/qc/inspection', icon: ClipboardList },
];
            ...
            <header className="fixed top-[10px] left-[10px] right-[10px] h-16 bg-white/80 dark:bg-gray-800/90 backdrop-blur-md border-theme z-40 px-6 flex items-center justify-between transition-colors duration-300 rounded-2xl shadow-floating">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3 pl-2 border-l border-gray-200 dark:border-gray-700">
                        <div onClick={() => navigate('/qc/settings')} className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg p-1 transition-colors">
