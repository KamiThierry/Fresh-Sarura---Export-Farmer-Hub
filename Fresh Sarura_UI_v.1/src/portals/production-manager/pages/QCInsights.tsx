...
const QCInsights = () => {
    ...
    const filteredBatches = batches.filter(b => {
        ...
        return matchesSearch && matchesGrade && matchesDefect;
    });
    ...
    const handleExportXLSX = () => {
        ...
        if (activeTab === 'log') {
            ...
            const rows = filteredBatches.map(b => [
                new Date(b.updatedAt || b.createdAt).toLocaleDateString('en-GB'),
                b.cropName || '—',
                b.stockId || '—',
    ...
    const handleExportPDF = async () => {
        ...
        if (activeTab === 'dashboard') {
            ...
            autoTable(doc, {
                ...
                body: filteredBatches.map(b => [
                    new Date(b.updatedAt || b.createdAt).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' }),
                    b.cropName || '—',
                    b.stockId || '—',
                    b.cycleId?.farmer_id?.full_name || b.cycleId?.farmer_id?.cooperative_name || b.cycleId?.farm_name || '—',
        ...
        doc.text('REPORT INSIGHTS', 15, lastY + 15);
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            doc.text('This is a computer generated report by Fresh Sarura. No signature required.', pageWidth / 2, pageHeight - 15, { align: 'center' });
                ...
                {activeTab === 'log' && (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="flex items-center gap-3 p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-900/10 flex-wrap">
                            ...
                            {(searchQuery || gradeFilter !== 'all' || defectFilter !== 'all') && (
                                <button
                                    onClick={() => { setSearchQuery(''); setGradeFilter('all'); setDefectFilter('all'); setCurrentPage(1); }}
