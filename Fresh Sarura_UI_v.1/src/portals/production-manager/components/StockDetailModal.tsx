                ...
                autoTable(doc, {
                    ...
                    didParseCell: (data) => {
                        if (data.section === 'body' && data.column.index === 6) {
                            ...
                            if (s.includes('ready'))    data.cell.styles.textColor = [22, 163, 74];
                            if (s.includes('shipped'))  data.cell.styles.textColor = [37, 99, 235];
                            if (s.includes('pending'))  data.cell.styles.textColor = [124, 58, 237];
                        }
                    }
                });
